...
public class InitialFinalState extends OldGridElement {
	...
	public void paintEntity(Graphics g) {
		...
		if (!initialState) {
			...
			g2.fillOval((int) (4 * zoom), (int) (4 * zoom), getRectangle().getWidth() - (int) (8 * zoom), getRectangle().getHeight() - (int) (8 * zoom));
		}
		else {
			g2.fillOval(0, 0, getRectangle().getWidth(), getRectangle().getHeight());
		}
	}
}
